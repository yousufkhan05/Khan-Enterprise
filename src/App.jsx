...
export default function App() {
  ...
  return (
    <div className={`min-h-screen flex flex-col transition-colors duration-500 font-sans ${
      ...
      <footer className="w-full border-t border-slate-200 dark:border-slate-900 bg-white dark:bg-slate-900/40 py-4 text-center text-[10px] text-slate-400 mt-auto">© {new Date().getFullYear()} Khan Enterprise. All Rights Reserved. Developed by Yousuf</footer>
